...
class User(object):
    ...
    def set_attacking_pokemon(self, pokemon_number):
    ...
    def choose_attack(self, attack_name, enemy):
...
class Computer(User):
    def play_turn(self, enemy):
        ...
        if self.attacking_pokemon.knocked_out:
            self.set_attacking_pokemon()
        elif random_turn < 4:
            self.choose_attack(enemy)
        elif random_turn == 4:
            self.heal()
        elif random_turn == 5:
            self.set_attacking_pokemon()
    ...
    def set_attacking_pokemon(self):
        if self.is_end_game():
            return
...
def game_loop():
    ...
    while not game_over:
        ...
        if user_input == "attack":
            ...
            player.choose_attack(attack_name, computer.attacking_pokemon)
